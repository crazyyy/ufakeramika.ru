...
; /* Start:"a:4:{s:4:"full";s:76:"/local/templates/vjweb_corplite_modern_blue/js/jquery.min.js?150963307995786";s:6:"source";s:60:"/local/templates/vjweb_corplite_modern_blue/js/jquery.min.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:59:"/local/components/nav/search.ajax/script.js?151600992413977";s:6:"source";s:43:"/local/components/nav/search.ajax/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
    function JCTitleSearch(arParams) {
        ...
        this.Init = function () {
            ...
            this.INPUT = document.getElementById(this.arParams.INPUT_ID);//title-search-result
			...
			document.body.onclick = function(e) {
				...
				if(e.target.className){
                    var q = document.querySelectorAll("#title-search-result ." + e.target.className);
                    if(q.length == 0)
                    	_this.onFocusLost();
				}
...
; /* /local/components/nav/search.ajax/script.js?151600992413977*/
